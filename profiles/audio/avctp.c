...
static struct {
	...
	{ "LEFT UP",		AVC_LEFT_UP,		KEY_LEFT_UP },
	{ "LEFT DOWN",		AVC_LEFT_DOWN,		KEY_LEFT_DOWN },
	{ "RIGHT UP",		AVC_RIGHT_UP,		KEY_RIGHT_UP },
	{ "RIGHT DOWN",		AVC_RIGHT_DOWN,		KEY_RIGHT_DOWN },
	...
	{ "SOUND SELECT",	AVC_SOUND_SELECT,	KEY_SOUND },
	{ "INPUT SELECT",	AVC_INPUT_SELECT,	KEY_CONFIG },
	{ "SETUP",		AVC_SETUP_MENU,		KEY_SETUP },
	...
	{ "SUBPICTURE",		AVC_SUBPICTURE,		KEY_SCREEN },
	{ "ANGLE",		AVC_ANGLE,		KEY_ANGLE },
	{ "F1",			AVC_F1,			KEY_F1 },
	{ "F2",			AVC_F2,			KEY_F2 },
	{ "F3",			AVC_F3,			KEY_F3 },
	{ "F4",			AVC_F4,			KEY_F4 },
	...
	{ "F8",			AVC_F8,			KEY_F8 },
	{ "F9",			AVC_F9,			KEY_F9 },
	{ "PAGE UP",		AVC_PAGE_UP,		KEY_PAGEUP },
	{ "PAGE DOWN",		AVC_PAGE_DOWN,		KEY_PAGEDOWN },
	{ "RED",		AVC_RED,		KEY_RED },
					...
					size_t operand_count, void *user_data)
{
	...
	if (key_map[i].name == NULL) {
		if ((operands[0] & 0x7F) == AVC_VENDOR_UNIQUE)
			goto done;
